...
本项目使用标准的 Python 虚拟环境，**不依赖 Anaconda**：

- **Python**: 3.8+ (推荐 3.10)
- **操作系统**: Linux (推荐 Ubuntu/CentOS)
- **虚拟环境**: Python venv
- **关键依赖**: vnpy, vnpy-ctp, ta-lib

### 环境优势

- **轻量级**: 不依赖 Anaconda 的庞大环境
- **稳定**: 减少环境依赖的复杂性
- **快速**: 启动和运行速度更快
- **灵活**: 更容易部署和维护
...
系统已成功解决 `vnpy-ctp` 的安装问题，支持连接真实的 CTP 仿真服务器。详细解决方案请参考 [CTP_SIM_SETUP.md](CTP_SIM_SETUP.md)。
